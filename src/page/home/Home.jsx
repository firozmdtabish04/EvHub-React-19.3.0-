    ...
    <section className="min-h-screen overflow-hidden bg-black text-white relative">
      ...
      <div className="px-5 pt-28 pb-12 z-10 mx-auto min-h-screen max-w-7xl relative flex items-center sm:px-8 lg:px-10">
        <div className="grid gap-10 w-full items-center lg:grid-cols-2">
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex-col mt-10 gap-5 flex sm:flex-row sm:items-center">
              ...
              <div className="gap-3 flex items-center">
                ...
                <div>
                  <p className="font-semibold text-lime-400">Let's Join Us.</p>
          ...
          {/* RIGHT SIDE */}
          <div className="relative h-[620px] hidden lg:block xl:h-[720px]">
            {/* Charger */}
            <img
              src={charger}
              alt="EV Charger"
              className="absolute right-0 top-0 w-[240px] xl:w-[280px] drop-shadow-[0_0_70px_rgba(132,255,76,0.25)]"
            />
            ...
            <img
              src={car}
              alt="EV Car"
              className="absolute bottom-0 left-[-60px] w-[560px] xl:w-[700px] drop-shadow-[0_25px_70px_rgba(0,0,0,0.65)]"
            />
          </div>
        </div>
      </div>
